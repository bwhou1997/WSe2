...
EPW="/scratch1/08237/bwhou/test/EPW/q-e/bin"
...
#
ibrun ~/software/qe-6.7/bin/pw.x -nk 16 -input scf.in > scf.out
ibrun ~/software/qe-6.7/bin/ph.x -nk 16 -input ph.in > ph.out
